...
class PrecursorWriter(Sampler):
    def __init__(self, para: Parameter, cuda_memory_manager: CudaMemoryManager, filename: str, output_path: str, x_pos: float, y_min: float, y_max: float, z_min: float, z_max: float, t_start_out: int, t_save: int, output_variable: OutputVariable, max_timesteps_per_file: int) -> None: ...
